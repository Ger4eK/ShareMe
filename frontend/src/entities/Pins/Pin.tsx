...
type Props = { pin: any; className: string };

const Pin = ({ pin: { postedBy, image, _id, destination, save } }: Props) => {
  ...
  return (
    <div className='m-2'>
      ...
      >
        ...
        {postHovered && (
          <div
            ...
            // ! tailwind h-full has some issue so we use style for adding h100%
            style={{ height: '100%' }}
          >
      ...
      <Link
        ...
        className='flex rounded-lg shadow-lg gap-2 mt-2 items-center'
      >
        <img
